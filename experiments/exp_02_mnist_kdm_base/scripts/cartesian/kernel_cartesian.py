#!/usr/bin/env python3
"""exp_02 / variante "cartesian" — cascada KDM (tronco ResNet-34 compartido +
2 cabezas KDM por dígito + KDM final vía cartesian_product) en MNIST-Addition.

Condición: kdm-final-cartesian_seed42
...
WORK = "/kaggle/working"
NPC_ROOT = f"{WORK}/npc"
CONDITION = "kdm-final-cartesian_seed42"
