...
__CONDITION__/__SEED__/__EPOCHS__/__N_COMP_HEAD__/__N_COMP_FINAL__/__LR_KDM__/
__SIGMA_MULT__ y escribe una copia por condición en scripts/<condición>/.
